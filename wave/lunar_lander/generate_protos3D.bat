...
set PLUGIN=%UserProfile%\.nuget\packages\Grpc.Tools\1.14.2\tools\windows_x64\grpc_csharp_plugin.exe

%PROTOC% -I../protos --csharp_out Lunar3D ../protos/Lunar3D.proto --grpc_out Lunar3D --plugin=protoc-gen-grpc=%PLUGIN%
